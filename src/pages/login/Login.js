...
import ForgotPasswordForm from 'components/authentication/ForgetPasswordForm';
                ...
                <Col lg={9} className="mx-auto">
                  <Card className="p-4 rounded-4 h-fit">
                    <Card.Body className="p-0 d-flex flex-column gap-lg-4 gap-3">
                      ...
                      <LoginForm layout="card" hasLabel handleForgot={handleForgotPassword} handleChangePassword={() => setIsChangePassword(!isChangePassword)} />
