export const packagingMaterialRoutes = {
  ...
  children: [
    {
      ...
      children: [
        {
          name: 'Warehouse Packaging Material',
          exact: true,
          active: true,
          children: [
            {
              name: 'Generate PS from PO',
              to: '/warehouse/Whs201_genPSfromPO/PM',
              exact: true,
              active: true
            }
          ]
        },
        {
          ...
          children: [
            {
              name: 'Generate PS from PO (RM)',
              to: '/warehouse/Whs201_genPSfromPO/RM',
              exact: true,
              active: true
            }
          ]
...
export const stockLocationOpnameRoutes = {
  label: 'Opname',
  labelDisable: true,
  children: [
    {
      ...
      children: [
        {
          ...
          children: [
            {
              name: 'Stock Location Jumbo',
              to: '/opname/whm390_Loc_JB',
              exact: true,
              active: true
            }
          ]
...
export default [
  packagingMaterialRoutes //,
  // stockLocationOpnameRoutes,
  // dashboardRoutes,
  // appRoutes,
  // pagesRoutes,
  // modulesRoutes,
