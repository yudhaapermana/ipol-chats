      ...
      {Object.prototype.hasOwnProperty.call(item, 'children') ? (
        <>
          <div className="toggle-container">
            ...
            >
              <p
                className={classNames('treeview-text', { 'ms-2': !selection })} style={item.style}
              >
                {item.del ? (
                  <del>{item.name}</del>
                ) : (
                ...
                {item.badge ?
                  (item.badge.map(badge => (<Badge bg={badge.type} className="ms-2">{badge.text}</Badge>))
                  ) :
                  ('')
                }
              </p>
        ...
        <div className="treeview-item">
          ...
          <a href="#!" className="flex-1">
            <p className="treeview-text" style={item.style}>
              <FontAwesomeIcon
                icon={item.icon}
