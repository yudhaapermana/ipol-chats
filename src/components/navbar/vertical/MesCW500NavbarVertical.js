...
import LogoIndopoly from 'assets/img/imes/logo.png';
import axios from 'axios';
import MesCW500Logo from 'components/common/MesCW500Logo';

const MesCW500NavbarVertical = () => {
    ...
    <>
      ...
      >
        <Flex alignItems="center">
          {/* <ToggleButton /> */}
          {CheckDev.isMobile ? <Logo at="navbar-top" width={150} id="Mlogo" /> : <MesCW500Logo at="navbar-top" width={28} id="Dlogo" />}
        </Flex>
        {/* <Navbar.Collapse
          in={showBurgerMenu}
...
MesCW500NavbarVertical.propTypes = {
  label: PropTypes.string
};

export default MesCW500NavbarVertical;
