...
const MesCW500ProfileDropdown = () => {
  ...
  return (
    <Dropdown navbar={true} as="li">
      {lgdata && (
        <>
          <Dropdown.Toggle bsPrefix="toggle" as={Link} to="#!" className="pe-1 ps-3 nav-link d-flex align-items-center gap-2">
            <Avatar src={img} size="xl" />
            <div className="d-flex flex-column gap-0">
              <p className="m-0 text-dark fs-10">{lgdata.UserName}</p>
              <small className="m-0 text-600 fs-10 fw-light">{lgdata.NIK}</small>
            </div>
          </Dropdown.Toggle>
...
export default MesCW500ProfileDropdown;
